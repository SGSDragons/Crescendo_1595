...
public class LaunchTeleop extends Command {
  ...
  public LaunchTeleop(LauncherSubsystem launcherSubsystem, IndexerSubsystem indexerSubsystem, PneumaticsSubsystem pneumaticsSubsystem, LaunchDirection direction, boolean automatic, Joystick controller) {
